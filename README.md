...
> Status: **474 Vitest tests · 7 routes · 29 lib modules · 37 scripts · 16 components · 4-layer safety net**
...
# 전체 CI 시뮬레이션 (lint + 474 tests + C4.1 + build)
npm run ci
```
...
- **`pr-check.yml`**: PR 마다 lint + 474 tests + C4.1 + build 자동 게이트
...
- **Testing**: Vitest 4.1.7 (51 test files, 474 tests)
