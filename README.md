...
> Status: **471 Vitest tests · 7 routes · 29 lib modules · 36 scripts · 15 components · 4-layer safety net**
...
# 전체 CI 시뮬레이션 (lint + 471 tests + C4.1 + build)
npm run ci
```
...
- **`pr-check.yml`**: PR 마다 lint + 471 tests + C4.1 + build 자동 게이트
...
- **Testing**: Vitest 4.1.7 (50 test files, 471 tests)
