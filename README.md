...
# 전체 CI 시뮬레이션 (lint + 342 tests + C4.1 + build)
npm run ci
```
...
- **`pr-check.yml`**: PR 마다 lint + 342 tests + C4.1 + build 자동 게이트
...
- **Testing**: Vitest 4.1.7 (36 test files, 342 tests)
