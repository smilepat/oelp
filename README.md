...
> Status: **484 Vitest tests · 8 routes · 31 lib modules · 37 scripts · 17 components · 4-layer safety net**
...
# 전체 CI 시뮬레이션 (lint + 484 tests + C4.1 + build)
npm run ci
```
...
- **`pr-check.yml`**: PR 마다 lint + 484 tests + C4.1 + build 자동 게이트
...
- **Testing**: Vitest 4.1.7 (52 test files, 484 tests)
