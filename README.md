...
> Status: **463 Vitest tests · 7 routes · 28 lib modules · 35 scripts · 15 components · 4-layer safety net**
...
# 전체 CI 시뮬레이션 (lint + 463 tests + C4.1 + build)
npm run ci
```
...
- **`pr-check.yml`**: PR 마다 lint + 463 tests + C4.1 + build 자동 게이트
...
- **Testing**: Vitest 4.1.7 (49 test files, 463 tests)
