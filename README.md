...
> Status: **486 Vitest tests · 8 routes · 31 lib modules · 38 scripts · 17 components · 4-layer safety net**
...
# 전체 CI 시뮬레이션 (lint + 486 tests + C4.1 + build)
npm run ci
```
...
- **`pr-check.yml`**: PR 마다 lint + 486 tests + C4.1 + build 자동 게이트
...
- **Testing**: Vitest 4.1.7 (53 test files, 486 tests)
