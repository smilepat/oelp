...
> Status: **407 Vitest tests · 7 routes · 24 lib modules · 34 scripts · 14 components · 4-layer safety net**
...
# 전체 CI 시뮬레이션 (lint + 407 tests + C4.1 + build)
npm run ci
```
...
- **`pr-check.yml`**: PR 마다 lint + 407 tests + C4.1 + build 자동 게이트
...
- **Testing**: Vitest 4.1.7 (43 test files, 407 tests)
