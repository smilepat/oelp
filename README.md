...
> Status: **334 Vitest tests · 7 routes · 20 lib modules · 20 scripts · 11 components · 4-layer safety net**
...
# 전체 CI 시뮬레이션 (lint + 334 tests + C4.1 + build)
npm run ci
```
...
- **`pr-check.yml`**: PR 마다 lint + 334 tests + C4.1 + build 자동 게이트
...
- **Testing**: Vitest 4.1.7 (35 test files, 334 tests)
