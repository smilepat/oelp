...
> Status: **119 Vitest tests · 6 routes · 14 lib modules · 4-layer safety net**
...
# 전체 CI 시뮬레이션 (lint + 119 tests + C4.1 + build)
npm run ci
```
...
- **`pr-check.yml`**: PR 마다 lint + 119 tests + C4.1 + build 자동 게이트
...
- **Testing**: Vitest 4.1.7 (10 test files, 119 tests)
